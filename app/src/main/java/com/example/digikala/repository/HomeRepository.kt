...
class HomeRepository @Inject constructor(
    ...
    suspend fun getMostVisitedItems(): NetworkResults<List<StoreProduct>> = safeApiCall {
        api.getMostVisitedItems()
    }

    suspend fun getMostFavoriteItems(): NetworkResults<List<StoreProduct>> = safeApiCall {
        api.getMostFavoriteItems()
    }

    suspend fun getMostDiscountedItems(): NetworkResults<List<StoreProduct>> = safeApiCall {
